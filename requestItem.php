...
?>
    <div class="container-xxl py-5">
        <div class="container">
            ...
            <div class="row g-5">
            <div class="col-md-12">
            <h1 class="display-2 text-dark text-center mb-4 animated slideInDown">REQUEST ITEM NOW</h1>           
                        ...
                        <div class="row ">
                            ...
                            <div class="col-md-12 mt-2">
                                <div class="form-floating">
                                    ...
                                    <label for="name">Date You Want</label>
                                </div>
                            </div>
...
<?php
    if(isset($_REQUEST['submit']))
    {
        ...
        $dod = ($_REQUEST['dod']);
        $dId = $_SESSION['userId'];
        $query = "INSERT INTO `donate_request`
        (foodId,`qty`,`recieverId`, `requestDate`, `isRequest`, `isPending`) 
        VALUES ('$itemId','$qty','$dId','$dod',1,1)";
        ...
        if($result>0)
        {
            ...
            echo "<script>window.location.assign('donateitem.php?msg=Successfully Request for Donation&status=success')</script>";
