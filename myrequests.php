...
?>
    <div class="container-xxl py-5">
        <div class="container">
            ...
            <div class="row g-5">
            <div class="col-md-12">
            <h1 class="display-2 text-dark text-center mb-4 animated slideInDown">My Requested Items</h1>           
            <?php if (isset($_REQUEST['msg'])) {
                ...
                <table class="table table-bordered ">
                        ...
                        where donate_request.isRequest=1 and donate_request.recieverId='.$dId;
                        ...
                        if ($data = mysqli_fetch_array($res)) {
                            do{
                                ?>
                                    ...
                                    <td><?php if($data['donarId']!=0) echo $data['donationDate']; ?></td>                                   </tr>
